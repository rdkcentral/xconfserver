...
public enum ExportFileNames {
    ...
    ALL_TELEMETRY_TWO_RULES("allTelemetryTwoRules"),
    TELEMETRY_RULE("telemetryRule_"),
    TELEMETRY_TWO_RULE("telemetryTwoRule_"),
    TELEMETRY_TWO_PROFILE("telemetryTwoProfile_"),
    ALL_TELEMETRY_TWO_PROFILES("allTelemetryTwoProfiles_"),
