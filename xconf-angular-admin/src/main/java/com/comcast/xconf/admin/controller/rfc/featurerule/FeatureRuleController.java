...
public class FeatureRuleController extends ApplicationTypeAwayController<FeatureRule> {
    public static final String URL_MAPPING = "api/rfc/featurerule";
    ...
    @RequestMapping(value = "/allowedNumberOfFeatures", method = RequestMethod.GET)
    public ResponseEntity getAllowedNumberOfFeatures() {
        return new ResponseEntity<>(featureRuleService.getAllowedNumberOfFeatures(), HttpStatus.OK);
    }
}
