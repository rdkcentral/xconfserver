...
@RestController
@RequestMapping(value = DeviceSettingsController.URL_MAPPING, produces = MediaType.APPLICATION_JSON_VALUE)
public class DeviceSettingsController extends AbstractController<DeviceSettings> {

    public static final String URL_MAPPING = "api/dcm/deviceSettings";
