...
public class Permissions {
    ...
    public static final String READ_DCM_RDLCLOUD = "read-dcm-rdkcloud";
    ...
    public static final String WRITE_DCM_RDKCLOUD = "write-dcm-rdkcloud";
    ...
    public static final String READ_FIRMWARE_RDKCLOUD = "read-firmware-rdkcloud";
    ...
    public static final String WRITE_FIRMWARE_RDKCLOUD = "write-firmware-rdkcloud";
    ...
    public static final String READ_TELEMETRY_RDKCLOUD = "read-telemetry-rdkcloud";
    ...
    public static final String WRITE_TELEMETRY_RDKCLOUD = "write-telemetry-rdkcloud";
    public static final String WRITE_TELEMETRY_ALL = "write-telemetry-*";

    public static final String READ_CHANGES_XHOME = "read-changes-xhome";
    public static final String READ_CHANGES_STB = "read-changes-stb";
    public static final String READ_CHANGES_RDKCLOUD = "read-changes-rdkcloud";
    public static final String READ_CHANGES_ALL = "read-changes-*";

    public static final String WRITE_CHANGES_XHOME = "write-changes-xhome";
    public static final String WRITE_CHANGES_STB = "write-changes-stb";
    public static final String WRITE_CHANGES_RDKCLOUD = "write-changes-rdkcloud";
    public static final String WRITE_CHANGES_ALL = "write-changes-*";
}