...
public class UpdateDateAspectTest extends BaseQueriesControllerTest {

    @Test
    public void verifyDateIsUpdated() {
        createAndSaveModel(defaultModelId);
        Model model = modelDAO.getOne(defaultModelId.toUpperCase());
