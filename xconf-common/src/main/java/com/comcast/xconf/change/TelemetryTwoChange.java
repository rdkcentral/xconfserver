...
@CF(cfName = "XconfTelemetryTwoChange")
public class TelemetryTwoChange<T extends IPersistable> extends XMLPersistable implements Comparable<TelemetryTwoChange<T>>, Applicationable {
    ...
    @JsonSubTypes({@JsonSubTypes.Type(value = TelemetryTwoProfile.class)})
    private T newEntity;
    ...
    public boolean equals(Object o) {
        ...
        TelemetryTwoChange<?> change = (TelemetryTwoChange<?>) o;
    ...
    @Override
    public int compareTo(TelemetryTwoChange o) {
    ...
    public static class Builder<T extends IPersistable> {
        private TelemetryTwoChange<T> newChange;

        public Builder() {
            newChange = new TelemetryTwoChange<>();
        }
        ...
        public TelemetryTwoChange<T> build() {
            return newChange;
        }
    }
}
